 ...
 */
const DOCK_ITEMS = [
  { id: 'finder',       label: 'Finder',       quip: 'QUEL file è qui da qualche parte',        icon: import.meta.env.BASE_URL + 'icons/finder.png' },
  { id: 'chrome',       label: 'Chrome',        quip: 'Clicca qui per la mia versione professionale',                 icon: import.meta.env.BASE_URL + 'icons/chrome.png', action: () => window.open('https://www.linkedin.com/in/claudia-massimino-3a396a241/', '_blank') },
  { id: 'mail',         label: 'Mail',          quip: 'Se ti ho convinto, scrivimi <3',                   icon: import.meta.env.BASE_URL + 'icons/mail.png', action: () => window.location.href = 'mailto:claudiamasssimino@gmail.com?subject=Contatto dal Portfolio' },
